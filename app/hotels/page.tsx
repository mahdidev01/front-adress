...
const HotelListingsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6 px-6 py-10 container mx-auto">
      ...
      {/* Filter section */}
      <div className="w-full bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-8 space-y-4 md:space-y-0 md:flex md:items-end md:flex-wrap md:gap-4 overflow-hidden">
        {/* City Selector */}
