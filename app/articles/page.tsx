...
// import { Article, allArticles } from '../../app/data/articles'; // assure-toi que le chemin est correct
...
//                   asChild
//                   variant="secondary"
//                   className="mt-4 w-fit text-white bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30"
//                 >
